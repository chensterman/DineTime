...
import 'package:dinetime_mobile_mvp/ui/onboarding/locationpreferences_page/widgets/locationpreferences_button.dart';
import 'package:flutter/material.dart';

// Page to enable location settings
class LocationPreferencesLayout extends StatelessWidget {
  const LocationPreferencesLayout({Key? key}) : super(key: key);
