...
class PreorderReceiptItem extends StatefulWidget {
  final int quantity;
  final MenuItem menuItem;
  final StorageService clientStorage;
  const PreorderReceiptItem({
    Key? key,
  ...
  @override
  State<PreorderReceiptItem> createState() => _PreorderReceiptItemState();
}

class _PreorderReceiptItemState extends State<PreorderReceiptItem> {
